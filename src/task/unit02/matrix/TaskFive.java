...
/*
Дана последовательность натуральных чисел. Создать массив из четных чисел этой последовательности.
...
public class TaskFive {
    ...
    private static void createMatrixWithEvenNumbers(int[] matrix) {
        ...
        for (int i = 0; i < sizeOfMatrix; i++) { //найдем кол-во четных элементов в матрице
            if (matrix[i] % 2 == 0) {
                countEvenValue++;
            }
        }
